...
interface OptimizedFlashcardListProps {
...
export function OptimizedFlashcardList({ flashcards, onSelect, onEdit, onReject }: OptimizedFlashcardListProps) {
  ...
  useEffect(() => {
    ...
    const updateVisibleRange = () => {
      ...
      const end = Math.min(flashcards.length, Math.ceil((scrollTop + clientHeight) / itemHeight) + buffer);
  ...
  return (
    <div ref={containerRef} className="h-[600px] overflow-auto" style={{ scrollbarWidth: "thin" }}>
