...
describe("FlashcardService.createFlashcard", () => {
  ...
  it("should create and return a flashcard when supabase returns data without error", async () => {
    ...
    expect(insertMock).toHaveBeenCalledWith([
      { front_content: command.front_content, back_content: command.back_content, user_id: userId },
    ]);
...
describe("FlashcardService.deleteFlashcard", () => {
  ...
  it("should throw NotFoundError when flashcard does not exist", async () => {
    ...
    await expect(flashcardService.deleteFlashcard(flashcardId, userId)).rejects.toThrow(NotFoundError);
  ...
  it("should throw error when delete operation fails", async () => {
    ...
    await expect(flashcardService.deleteFlashcard(flashcardId, userId)).rejects.toThrow("Failed to delete flashcard");
  });
});
