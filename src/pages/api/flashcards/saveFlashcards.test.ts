...
describe("POST /api/flashcards", () => {
  ...
  it("should accept empty flashcards array", async () => {
    ...
    expect(flashcardService.approveFlashcards).toHaveBeenCalledWith({ flashcards: [] }, DEFAULT_USER_ID, undefined);
  });
  ...
  it("should return 500 when an error occurs", async () => {
    ...
    expect(loggerService.logError).toHaveBeenCalledWith(DEFAULT_USER_ID, "INTERNAL_ERROR", "Test error");
  });
});
